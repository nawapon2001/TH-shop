...
`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 py-10">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-orange-200 shadow-xl p-8">
        <h1 className="text-3xl font-bold text-orange-700 mb-6">ข้อตกลงการใช้งานแพลตฟอร์ม TH-THAI</h1>
